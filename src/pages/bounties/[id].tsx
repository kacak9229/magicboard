...
const product = {
  name: "Design an Uber Logo",

  price: "$220",
  description: "You have 50% chances to win the bounty",
  highlights: [
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <dd>
                      <time dateTime={"2022-01-10T17:00"}>
                        {"January 10th, 2022.date"} at {"5:00 PM"}
                      </time>
                    </dd>
                  </div>
                </div>
                    ...
                    <dl>
                      {faqs.map((faq) => (
                        <Fragment key={faq.question}>
                          ...
                          <dd className="prose-sm prose mt-2 max-w-none text-gray-500">
                            <p>{faq.answer}</p>
                          </dd>
                        </Fragment>
                      ))}
