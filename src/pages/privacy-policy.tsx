...
export default function PrivactyPolicy() {
  return (
    <Layout>
      <div className="relative overflow-hidden bg-white py-16">
        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-prose text-lg">
            ...
            <p className="mt-8text-xl leading-8 text-gray-500">
              Your privacy is important to us. It is Magicboard&#39;s policy to
              ...
              <span>{""}</span>
              <a
                className="ml-1 mr-1 text-indigo-600"
          ...
          <div className="prose-lg prose prose-indigo mx-auto mt-6 text-gray-500">
            <p>
              This policy is effective as of 4 March 2021 and was last updated
              on 4 March 2021.
            </p>
